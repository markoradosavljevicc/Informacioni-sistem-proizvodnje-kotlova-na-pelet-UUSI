...
<div class="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Izmeni Proizvod</h2>
    ...
    <form action="{{ route('proizvods.update', $proizvod) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="naziv" value="{{ old('naziv', $proizvod->naziv) }}" required
            ...
            <div>
                ...
                <input type="text" name="model" value="{{ old('model', $proizvod->model) }}"
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <select name="tip_goriva" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <option value="pellet" {{ old('tip_goriva', $proizvod->tip_goriva) == 'pellet' ? 'selected' : '' }}>Pellet</option>
                    <option value="drvo" {{ old('tip_goriva', $proizvod->tip_goriva) == 'drvo' ? 'selected' : '' }}>Drvo</option>
                    <option value="ugalj" {{ old('tip_goriva', $proizvod->tip_goriva) == 'ugalj' ? 'selected' : '' }}>Ugalj</option>
                </select>
            ...
            <div>
                ...
                <input type="number" step="0.01" name="cena" value="{{ old('cena', $proizvod->cena) }}" required
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="number" name="na_stanju" value="{{ old('na_stanju', $proizvod->na_stanju) }}" required min="0"
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <select name="magacin_id" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    @foreach($magacini as $magacin)
                        <option value="{{ $magacin->id }}" {{ old('magacin_id', $proizvod->magacin_id) == $magacin->id ? 'selected' : '' }}>
