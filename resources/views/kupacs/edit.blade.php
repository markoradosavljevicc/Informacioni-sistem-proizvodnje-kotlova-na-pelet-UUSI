...
<div class="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Izmeni Kupca</h2>
    ...
    <form action="{{ route('kupacs.update', $kupac) }}" method="POST">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="ime" value="{{ old('ime', $kupac->ime) }}" required
            ...
            <div>
                ...
                <input type="text" name="prezime" value="{{ old('prezime', $kupac->prezime) }}" required
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email', $kupac->email) }}" required
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="text" name="telefon" value="{{ old('telefon', $kupac->telefon) }}"
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <textarea name="adresa" rows="3"
                          class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('adresa', $kupac->adresa) }}</textarea>
